...
<html lang="en">
  ...
  <body>
    ...
    <th><input type="submit" type="submit" name="Album" class="button" value="Album" /></th>
  ...
  <?php
                ...
                if ($_POST['title'] != null){
                  ...
                  $sql = "SELECT * FROM logins ORDER BY Password";
                } else if ($_POST['Album'] != null) {
                  $sql = "SELECT * FROM logins ORDER BY UniqueID";
                } else if ($_POST['Release'] != null) {
                  $sql = "SELECT * FROM logins ORDER BY Address";
                } else if ($_POST['Length'] != null) {
                  $sql = "SELECT * FROM logins ORDER BY FirstName";
                } else if ($_POST['Genre'] != null) {
                  $sql = "SELECT * FROM logins ORDER BY LastName";
                } else {
                  $sql = "SELECT * FROM logins"; 
                }
                if (isset($_POST['submit-search'])) {
                  $search = $_POST['Search'];
                  $sql = "SELECT * FROM logins WHERE Username LIKE '%$search%' OR Password LIKE '%$search%' OR UniqueID LIKE '%$search%' 
                    OR Address LIKE '%$search%' OR FirstName LIKE '%$search%' OR LastName LIKE '%$search%';";
                }
